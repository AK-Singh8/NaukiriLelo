...
const Footer = () => {
  return (
    <footer className="sticky border-t border-t-gray-200 py-2 bg-[#0d9488]">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold"><span className='text-red-600'>Naukiri</span>Lelo</h2>
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            <a href="https://x.com/Avesh2003" className="hover:text-gray-400" aria-label="Twitter">
            ...
            <a href="https://www.linkedin.com/in/avesh-singh-550118272/" className="hover:text-gray-400" aria-label="LinkedIn">
